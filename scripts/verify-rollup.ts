...
import { scanSegments } from "../backend/segments";
import { DEFAULT_METRICS } from "../backend/scan";
import { fmt, runScript, secondsSince } from "../utils/common.utils";
import { initObservability, log, shutdownObservability } from "../utils/telemetryUtils";
